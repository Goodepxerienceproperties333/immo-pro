    ...
    >
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-[#0055FF]/5 to-slate-50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#0055FF]/10 flex items-center justify-center">
              <ScrollText size={20} className="text-[#0055FF]" />
            </div>
            <div>
        ...
        <div className="px-6 py-5 space-y-4 overflow-auto flex-1">
          ...
          <div className="border border-slate-200 rounded-lg p-4 flex items-start gap-3 hover:border-[#0055FF]/40 transition-colors">
            <Checkbox
              id="acc-cgu"
              checked={acceptedCgu}
            ...
            <label htmlFor="acc-cgu" className="flex-1 cursor-pointer">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-800">
                  J&apos;accepte les <Link to="/legal/cgu" target="_blank" className="text-[#0055FF] hover:underline inline-flex items-center gap-0.5">Conditions Generales d&apos;Utilisation <ExternalLink size={11} /></Link>
                </span>
              </div>
          ...
          <div className="border border-slate-200 rounded-lg p-4 flex items-start gap-3 hover:border-[#0055FF]/40 transition-colors">
            ...
            <label htmlFor="acc-privacy" className="flex-1 cursor-pointer">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-800">
                  J&apos;ai lu la <Link to="/legal/privacy" target="_blank" className="text-[#0055FF] hover:underline inline-flex items-center gap-0.5">Politique de Confidentialite (RGPD) <ExternalLink size={11} /></Link>
                </span>
              </div>
              <div className="text-[11px] text-slate-500 mt-0.5 ml-6">
