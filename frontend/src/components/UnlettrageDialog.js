      ...
      <DialogContent className="max-w-3xl" data-testid="unlettrage-dialog">
        ...
        <div className="border border-slate-200 rounded-lg overflow-hidden">
          <div className="bg-slate-50 border-b border-slate-200 p-3 flex items-center gap-2 flex-wrap">
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-slate-800 text-sm flex items-center gap-1.5">
                <Link2 size={13} className="text-[#0055FF]" /> Relettrer directement a une autre facture
              </div>
              ...
              <div className="text-center text-sm text-slate-500 py-6">
                ...
                {!showAll && data?.current_supplier && (
                  <button
                    ...
                    className="ml-2 text-[#0055FF] hover:underline"
                  >
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-2 text-right">
                          <Button
                            size="sm"
                            className={`h-7 text-xs ${c.exact_match ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-[#0055FF] hover:bg-[#0040CC]'} text-white`}
