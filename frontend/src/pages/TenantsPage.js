  ...
  return (
    <div data-testid="tenants-page">
      <div className="page-header flex items-center justify-between">
        ...
        <Button onClick={openCreate} className="bg-[#022D52] hover:bg-[#1D4ED8]" data-testid="create-tenant-btn"><Plus size={16} className="mr-2" /> Nouveau</Button>
      </div>
        ...
        <DialogContent data-testid="tenant-dialog">
          ...
          <div className="space-y-4 mt-2">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <Button onClick={handleSave} className="bg-[#022D52] hover:bg-[#1D4ED8]" data-testid="tenant-save-btn">{editing ? 'Modifier' : 'Creer'}</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
