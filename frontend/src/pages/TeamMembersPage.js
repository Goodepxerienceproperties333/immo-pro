    ...
    <div className="space-y-4" data-testid="team-page">
      <div className="page-header flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md bg-[#022D52]/10 flex items-center justify-center text-[#022D52]"><Users size={20} /></div>
          <div>
        ...
        <Button onClick={openNew} className="bg-[#022D52] hover:bg-[#1D4ED8]" data-testid="new-member-btn">
        ...
        <CardContent className="pt-4">
          {loading ? (
            ...
            <div className="text-sm text-slate-500 italic text-center py-8">
              ...
              <br />
              <Button onClick={openNew} variant="link" className="text-[#022D52]">Ajouter votre premier gestionnaire</Button>
            </div>
          ) : (
                      ...
                      <td className="px-2 py-2 text-center">
                        <div className="flex justify-center gap-1">
                          {m.must_change_password && (
                            <Button size="sm" variant="outline" onClick={() => resendInvitation(m)} className="text-[#01213e] border-blue-300 h-7 px-2" title="Renvoyer l'invitation par email" data-testid={`resend-member-${m.id}`}>
                              <Mail size={12} />
                            </Button>
                          )}
      ...
      <Dialog open={dialog} onOpenChange={(o) => !o && setDialog(false)}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <DialogFooter>
            ...
            <Button onClick={save} className="bg-[#022D52] hover:bg-[#1D4ED8]" data-testid="member-save">
