...
FEATURES = [
    ...
    },
    {
        ...
        "features": [
            ...
            ("Factures multi-lignes", "Une facture, plusieurs categories de depense reparties avec cles de repartition differentes par ligne. Commentaire par ligne visible dans la liste des depenses."),
            ("Auto-apprentissage fournisseur", "Le systeme apprend la categorie de depense la plus utilisee par fournisseur et la pre-remplit automatiquement lors de la saisie."),
            ...
            ("Ventilation Occupant / Proprietaire", "Chaque categorie de depense peut avoir un ratio de repartition Occupant vs Proprietaire (ex: 70% locataire, 30% proprietaire)."),
    ...
    },
    {
        ...
        "features": [
            ...
            ("Splits multi-natures", "Une seule transaction bancaire peut etre repartie sur plusieurs categories de depense (utile pour les prelevements groupes)."),
